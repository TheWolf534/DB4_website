...
const MainPage = () => {
  ...
  async function fetchData() {
    const result = await fetch(
      "http://51.20.235.196:8000/api/sensor-data/latest"
    );
        ...
        <div class="overviewBorder">
          <div class="period-overview">
            <center>
              <Progress
                ...
                format={(percent) => <CustomText percent={percent + "ppm"} />}
                type="dashboard"
                percent={data.concentration}
                strokeColor={twoColors}
                style={FONT.smallInfo_12}
              />
            ...
            <center>
              <Progress
                size={progressCircleSize}
                format={(percent) => <CustomText percent={percent + "°"} />}
                type="dashboard"
          ...
          <div class="period-overview">
            <center>
              <Progress
                size={progressCircleSize}
                format={(percent) => <CustomText percent={percent + "W"} />}
                type="dashboard"
                percent={30}
                strokeColor={twoColors}
              />
